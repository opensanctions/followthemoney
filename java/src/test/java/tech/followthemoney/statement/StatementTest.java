...
public class StatementTest {
    ...
    private static final String ORIGIN = "bla.csv";
    ...
    public void testBasicConstructionAndGetters() {
        ...
        Statement stmt = new Statement(ID, ENTITY_ID, CANONICAL_ID, schema, 
            PROP_NAME, DATASET, ORIGIN, VALUE, LANG, ORIG_VALUE, false, 100L, 200L);
        ...
        assertEquals(ORIGIN, stmt.getOrigin());
    ...
    public void testEmptyStrings() {
        Schema schema = model.getSchema("Person");
        Statement stmt = new Statement(ID, ENTITY_ID, CANONICAL_ID, schema,
            PROP_NAME, DATASET, null, VALUE, null, null, false, 100L, 200L);
            
        assertEquals("", stmt.getLang());
        assertEquals("", stmt.getOrigin());
    ...
    public void testEquality() {
        ...
        Statement stmt2 = new Statement(ID, "different", "different", schema,
            "different", "other.csv", "different", "different", "xx", "different", true, 300L, 400L);
